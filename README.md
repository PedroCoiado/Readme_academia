...
|-|-|-|-|-|-|-|
|**Claude** No texto introdução e desenvolvimento (PRIMEIRO TEXTO).|Criar um texto formal com base nas crises operacionais seguindo os passos do escopo do professor.|Preciso que você faça um texto de introdução sobre meu trabalho de modelagem de banco de dados seguindo o levantamento de requisitos, use esses parâmetros Problema, objetivos e delimitação|Levantamento de requisitos e arquivo "esqueleto_de_entrega" feito pelo professor.|O texto gerado por IA identificava o "instrutor" como uma entidade, coisa que não é verdade de acordo com nosso levantamento de requisitos, contudo foi reformulado o texto deixando apenas o Professor como entidade|O grupo optou por um texto mais formal seguindo as regras do levantamento de requisitos|A IA ajudou com um texto formal porém ela comparou o instrutor como uma entidade de certa forma isso nós ajudou identificar Incoerências em nosso trabalho.|
|-|-|-|-|-|-|-|
